...
- [x] VERSION matches both READMEs and CHANGELOG.
- [x] English and Chinese hero PNG/SVG assets exist.
- [x] English and Chinese workflow PNG/SVG assets exist.
- [x] Package validator passes.
- [x] Unit tests pass.
- [x] Generated starter validator returns CLEAN.
- [x] Quality Gate returns CLEAN for the local release-candidate contents.
- [x] Security and privacy review is recorded.
- [x] DeepWheel visual review is recorded.
